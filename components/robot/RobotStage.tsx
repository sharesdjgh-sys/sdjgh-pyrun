          ...
          switch (cmd.type) {
            ...
            case "mechdog_action": {
              ...
              const ACTION_MAP: Record<string, { state: RobotState; label: string; ms: number; emotion?: RobotEmotion }> = {
                ...
                sit_dowm:        { state: "idle",        label: "앉기 🐾",         ms: 1800, emotion: "happy" },
                sit_down:        { state: "idle",        label: "앉기 🐾",         ms: 1800, emotion: "happy" },
                go_prone:        { state: "idle",        label: "엎드리기",        ms: 1600 },
                stand_two_legs:  { state: "idle",        label: "두 발로 서기 🐾", ms: 1900 },
                handshake:       { state: "idle",        label: "악수 🤝",         ms: 1700, emotion: "happy" },
                scrape_a_bow:    { state: "idle",        label: "인사 🙇",         ms: 1500 },
                nodding_motion:  { state: "idle",        label: "고개 끄덕이기",   ms: 1200 },
                boxing:          { state: "idle",        label: "권투 🥊",         ms: 2100 },
                stretch_oneself: { state: "idle",        label: "기지개 켜기",     ms: 1700 },
                pee:             { state: "idle",        label: "쉬~ 💧",          ms: 1800 },
                press_up:        { state: "idle",        label: "팔굽혀펴기 💪",  ms: 2000 },
                rotation_pitch:  { state: "idle",        label: "앞뒤 흔들기",    ms: 1300 },
                rotation_roll:   { state: "idle",        label: "좌우 흔들기",    ms: 1300 },
                left_foot_kick:  { state: "idle",        label: "왼발 차기 🦵",   ms: 1100 },
                right_foot_kick: { state: "idle",        label: "오른발 차기 🦵", ms: 1100 },
              };
